...
namespace Modulos_Core_MVC.Areas.General.Controllers
{
    ...
    public class TrabajadorController : Controller
    {
        ...
        public ContentResult GetAllTrabajadores()
        {
            return Content(JsonConvert.SerializeObject(UsuarioFacade.GetTrabajadores()));
        }
        ...
        {
            return RedirectToAction("Register", "Trabajador", new { area = "General", id = 0 });
        }

        public ActionResult Edit(int id)
        {
            ViewBag.RoleName = GetRol();
            return RedirectToAction("Register", "Trabajador", new { area = "General", id = id });
        }
        ...
        public ActionResult Register(FormCollection form)
        {
            ...
            try
            {
                ...
                {
                    persona.EsTrabajador = true;
                    persona.EsAdministrado = false;
                }
